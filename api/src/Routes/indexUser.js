...
const updateDataPerfil = require("./controllers/user_cuenta/updateInformacion");
const changeEmailPerfil = require("./controllers/user_cuenta/cambiosDeEmail");
...
router.use(
  "/perfil/update/email",
  [checkAuth, checkRolUserMiddleware],
  changeEmailPerfil
);
router.use(
  "/perfil/update/info",
