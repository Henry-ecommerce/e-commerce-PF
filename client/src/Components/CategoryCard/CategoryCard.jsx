...
const CategoryCard = ({nombre, imagen}) => {
    ...
    return (
    <>
    <Box width="300px" height="150px" bg="white" display="inline-block" borderRadius="15px">
        <Flex m="5px" mt="10px" alignItems="center" flexDirection="column" fontSize="15px" fontWeight="700">
        <Box _hover={{cursor: "pointer"}} maxHeight="150px" maxWidth="150px"><Link to={`/products`}><Image boxSize="115px" objectFit="scale-down" src={imagen} alt={nombre}/></Link></Box>
