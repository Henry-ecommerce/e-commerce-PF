...
import EditProctoOwner from "../EditProctoOwner/EditProctoOwner";

const ObtenerProductosOwner = () => {
  const {
    productos,
  ...
  return (
    <Flex>
      ...
      {formEdit && (
        <Box w="70%">
          <EditProctoOwner setFormEdit={setFormEdit} />
        </Box>
      )}
...
export default ObtenerProductosOwner;
