...
import logo from '../../Loading/logo192.png'
...
function Navbar() {
	...
	return (
		<Flex p="10px" justify={"space-between"} bg="#242525" color="#ECEDEC">
			{_width <= 688 ? (
				<Flex justify="space-between" align={"center"} mx="10px" w="99%">
					<Menu>
					...
					<Box mr="0">
						<Flex justify="space-between" align={"center"} mx="3px" w="99%">
							<Box mx="15px">
							...
							<Box cursor={"pointer"} ml={4} color="#ECEDEC">
								<Box mr="0">
									...
									<Menu autoSelect={false} closeOnSelect={false} mr="0">
										<MenuButton
											disabled={
												products_in_cart_local_storage?.length === 0 &&
												typeof products_in_cart_local_storage !== "string"
				...
				<>
					<Flex justify={"space-around"} align="center">
						<Box mx="15px">
							<Link to="/"><Image src={logo} alt='Logo' w='55px' borderRadius='5px'/></Link>
						</Box>
						<Box mx="15px">
							<Link to="/">Inicio</Link>
						</Box>
